...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "UbuntuMono Nerd Font Mono" :foundry "DAMA" :slant normal :weight bold :height 203 :width normal))))
